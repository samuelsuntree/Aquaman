...
# video_path = os.path.join(root_dir, "20240112_f57_crop1.mp4")
...
#video_path = os.path.join(root_dir, "trim1.mp4")
# 加载模型
...
def predict(model=model, cap=cap):
    ...
    y_dot_file = f'{output_path}/y_dot_{Vnum}.csv'
